...
export default function Menu() {
  ...
  return (
    <ul className='flex items-center gap-4 p-2'>
      ...
      <li><Link href="/product" className={pathname === '/product' ? 'text-red-500' : ''}>Product</Link></li>
      <li><Link href="/about" className={pathname === '/about' ? 'text-red-500' : ''}>About</Link></li>
      <li><Link href="/profile" className={pathname === '/profile' ? 'text-red-500' : ''}>Profile</Link></li>
    </ul>
  )
};
